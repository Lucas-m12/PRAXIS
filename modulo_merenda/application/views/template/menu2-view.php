...
<!-- <li class="sidebar-search">
    <div class="input-group custom-search-form">
        <input readonly="true" type="text" class="form-control" placeholder="Pesquisar...">
...
<li>
    ...
    <ul class="nav nav-second-level">
        <li>
            <a href="<?php echo base_url('pesquisa-sala'); ?>">Sala</a>
        </li>
        <li>
...
<li>
    ...
    <ul class="nav nav-second-level">
        ...
        <li>
            <a onclick="confirmExclusao()" href="<?php echo base_url('logoff'); ?>">Sair</a>
        </li>
    </ul>
</li> -->
