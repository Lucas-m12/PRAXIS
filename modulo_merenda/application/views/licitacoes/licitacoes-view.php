	...
	<script>
		window.app = new Pesquisa("form-pesquisa-licitacao", "<?php echo base_url('pesquisa-licitacao') ?>", 5, "<?php echo base_url('editar-licitacao') ?>", "<?php echo base_url('editar-licitacao') ?>", "<?php echo base_url('relatorio') ?>");
	</script>
