			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="form-autorizacao" method="POST" action="#" role="form">
		...
		<div class="panel panel-default">
            <div class="panel-heading">
                <div align="center">
                    <a type="button" href="<?php echo base_url('pedidos-gestor') ?>" class="btn btn-info">Voltar</a>
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		let formEl = document.getElementById('form-autorizacao');
        		...
        		formEl.addEventListener("submit", event => {
        			...
        			swal.fire({
        				title: "Selecione a ação desejada para o pedido",
        				icon: "warning",
        				showCancelButton: true,
        				confirmButtonColor: '#32CD32',
						cancelButtonColor: '#0000CD',
					  	confirmButtonText: 'Enviar Pedido Por Email',
					  	cancelButtonText: 'Imprimir Pedido'
        			}).then((result) => {
        				if (result.value) {
        					Swal.fire(
						      'Deleted!',
