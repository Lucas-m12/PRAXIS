							...
							<div class="col-lg-12">
								<form id="form-pedidos-edicao" method="POST" action="#" role="form">
									...
									<div class="form-group col-lg-6">
										...
										<input type="number" name="codigoPedido" id="codigoPedido" class="form-control" value="<?php echo $info['CODIGO_PEDIDO'] ?>" readonly>
									</div>

									<div class="form-group col-lg-6">
										<label class="control-label">Selecione o Fornecedor</label>
										<input type="text" name="fornecedor" id="fornecedor" class="form-control" disabled value="<?php echo $info['NOME_FORNECEDOR'] ?>">
									</div>

									<div class="form-group col-lg-6">
										<label class="control-label">Selecione o programa que receberá o pedido</label>
										<input type="text" name="programa" id="programa" class="form-control" value="<?php echo $info['DESC_PROGRAMA'] ?>" disabled>
									</div>

									<div class="form-group col-lg-6">
										<label class="control-label">Situação do pedido</label>
										<select class="form-control" name="statusPedido" id="statusPedido">
											<option selected value="<?php echo $info['STATUS'] ?>"><?php echo $info['TIPO_STATUS'] ?> / <?php echo $info['DESC_STATUS'] ?></option>
		...
		<script>
			window.app = new ItensPedido("form-pedidos-edicao", "<?php echo base_url('pesquisa-produtoForn') ?>", "<?php echo base_url('pesquisa-unidadeMedida') ?>", "<?php echo base_url('cadastrar-itensPedido') ?>", "<?php echo base_url('excluir-itemPedido') ?>", "<?php echo base_url('editar-statusPedido') ?>", "<?php echo base_url('pedidos') ?>");
		</script>
        ...
        <!-- <script src="\{$cidade}/modulo_merenda/public/scripts/controllers/EditarPedido.js"></script>
		<script src="\{$cidade}/modulo_merenda/public/scripts/editarPedido.js"></script> -->
