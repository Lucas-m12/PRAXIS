...
class Licitacao extends CI_Controller{
	...
	public function atualizarLicitacao(){
	    ...
	    $this->form_validation->set_rules('dataFim', 'data de fim', 'required', array('required' => 'Você deve preencher a %s.'));
	    $this->form_validation->set_rules('dataInicio', 'Data de início', 'required', array('required' => 'Você deve preencher a %s.'));
	    // $this->form_validation->set_rules('fornecedor', 'Fornecedor', 'required', array('required' => 'Você deve preencher o %s.'));
	    $this->form_validation->set_rules('numeroLicitacao', 'Número da Licitação', 'required', array('required' => 'Você deve preencher o %s.'));
        ...
        if ($this->form_validation->run() == FALSE) {
           ...
           echo json_encode("campos");
           	...
           	// $codigoFornecedor 	= $this->input->post("fornecedor");
           	$numeroLicitacao 	= $this->input->post("numeroLicitacao");
           	$dataFinal 			= $this->input->post("dataFim");
           	$dataInicial 		= $this->input->post("dataInicio");
           	$idLicitacao 		= $this->input->post("idLicitacao");
           	...
           	$this->licitacao->atualizarLicitacao();
	...
	public function relatorioLicitacao($idLicitacao){
		...
		$data['dados'] 	= $this->licitacao->relatorioLicitacao($idLicitacao);

		$this->load->view("relatorios/licitacao/licitacao", $data);
